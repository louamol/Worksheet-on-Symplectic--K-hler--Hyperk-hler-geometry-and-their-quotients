...
\section{Kähler manifolds}
    ...
    \subsection{Complex structure}
        ...
        \end{equation*}
        in the space of $(p,q)$-forms on $M$. This is the \emph{Hodge decomposition}\index{Hodge decomposition}. In terms of components, this means that any $\omega\in\Omega^{(p,q)}(M)$ can be written as
        \begin{equation}
